 ...
 ************************************************************************
 * 02/02/26 Pete Lombardo - Added CmpArtist subclass
...
public class Song implements Comparable {
    ...
    public int compareTo(Object that) {
        ...
        int artistComp = this.artist.compareToIgnoreCase(other.artist);
        if (artistComp != 0) {
            return artistComp;
        }
     ...
     */
    /**
     * Unit 2: Comparator for comparing songs by artist only.
     * It extends CmpCnt to allow for counting comparisons during searches.
     */
    public static class CmpArtist extends CmpCnt implements Comparator<Song> {
        /**
         * Compares two songs based on their artist field, case-insensitive.
         * * @param s1 the first song to compare
         * @param s2 the second song to compare
         * @return a negative integer, zero, or a positive integer as the
         * first artist is less than, equal to, or greater than the second.
         */
        @Override
